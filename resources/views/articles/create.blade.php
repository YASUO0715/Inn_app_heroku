    ...
    <form action="{{ route('articles.store') }}" method="post" enctype="multipart/form-data">
        <div class="card mb-3">
            ...
            <div class="row m-3">
                ...
                <div class="mb-3">
                    <label for="price" class="form-label"><b>金額を入力してください</b></label>
                    <input type="text" name="price" id="cprice" class="form-control" {{ old('price') }}>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="radio" name="category_id" value=1 {{ old('category_id')===1 ? 'checked' : '' }}>八幡平<br>
                    <input type="radio" name="category_id" value=2 {{ old('category_id')===2 ? 'checked' : ''
                        }}>安比高原<br>
                    <input type="radio" name="category_id" value=3 {{ old('category_id')===3 ? 'checked' : '' }}>焼走<br>
                </div>
